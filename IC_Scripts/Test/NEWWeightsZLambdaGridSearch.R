# =============================================================================
# LambdaGridSearch: choose λ via profile log-likelihood
# =============================================================================
library(fields)
...
LambdaGridSearch <- function(coord_model,
  ...
  if (doPlot) {
    ...
    lines(lGrid, profile_spline)
    abline(v = logLambdaHat, col = 2, lty = 2)
    title(main = "λ profile (spatial + Z, weighted)")
  }
