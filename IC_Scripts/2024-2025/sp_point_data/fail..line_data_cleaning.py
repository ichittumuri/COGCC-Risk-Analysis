...
line_data = line_data[line_data['Status'] != 'DROP_ROW']
...
line_data['Fluid'] = line_data['Fluid'].str.strip().str.title().replace(fluid_mapping)
print(sorted(line_data['Fluid'].dropna().unique()))
